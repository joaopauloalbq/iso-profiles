...
local revelation = {
    ...
    is_excluded = false,
    curr_tag_only = false,
    font = beautiful.revelation_font or "Noto Sans 20",
    bg = beautiful.revelation_fg_normal or beautiful.fg_normal or "#DCDCCC",
    fg = beautiful.revelation_bg_normal or beautiful.bg_normal or "#000000",
...
function revelation.expose(args)
    ...
    for scr=1,capi.screen.count() do
        t[scr] = awful.tag.new({revelation.tag_name[1]},
            scr, awful.layout.suit.fair.horizontal)[1]
        zt[scr] = awful.tag.new({revelation.tag_name[2]},
            scr, awful.layout.suit.fair.horizontal)[1]
...
function revelation.init(args)
    ...
    revelation.tag_name[1] = args.tag_name or revelation.tag_name[1]
    if args.match then
