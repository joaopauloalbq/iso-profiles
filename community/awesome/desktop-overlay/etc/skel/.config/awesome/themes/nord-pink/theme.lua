...
theme.bg_normal     = "#2d323a" --#353535
theme.bg_focus      = "#4c5158"
theme.bg_urgent     = "#F06C6C"
theme.bg_minimize   = "#1e222a" -- #272727
...
theme.border_focus  = "#dc98b1" -- #64A7A7 #41C6C8 #222222
...
theme.notification_bg = "#323946" -- theme.bg_focus
...
content = content:gsub("darker%-background%-color: (%g+);", ("darker-background-color: " .. "#282C33" .. ";"), 1)
