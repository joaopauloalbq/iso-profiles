...
function init()
    ...
    config.TryBindKey("Ctrl-b", "lua:initlua.build", true)
    config.TryBindKey("Ctrl-o", "lua:initlua.output", true)
    ...
    config.TryBindKey("Alt-l", "lua:initlua.lint", false)
